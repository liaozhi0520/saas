...
urlpatterns=[
    ...
    re_path(r'^manage/(?P<project_id>\d+)/',include([
        ...
        re_path(r'^issue/$',IssuesView.as_view(),name='issue'),
        re_path(r'^issue/list$',IssueListView.as_view(),name='issue_list'),
        re_path(r'^issue/details/(?P<issue_id>\d+)$', IssueDetailsView.as_view(), name='issue_details'),
        re_path(r'^issue/details/(?P<issue_id>\d+)/update$',IssueDetailsUpdateView.as_view(),name='issue_details_update'),
        re_path(r'^issue/details/(?P<issue_id>\d+)/delete$',IssueDetailsDeleteView.as_view(),name='issue_details_delete'),
